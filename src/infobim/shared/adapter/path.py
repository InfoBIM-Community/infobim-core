...
class CliPathAdapter:
    """Normalize and resolve paths received through the InfoBIM CLI."""
    ...
    def resolve(self, raw_path: str, root_path: Optional[str] = None) -> Path:
        candidate_path: Path = Path(self.normalize(raw_path)).expanduser()
