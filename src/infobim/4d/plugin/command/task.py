...
from ...adapter.screen import serve
from ...adapter.workbook import (
    ScheduleWorkbookAdapter,
    ScheduleWorkbookError,
)


class FourDTaskCommand(CliCommandPort):
        ...
        arguments=[
            ...
            },
            {
                ...
                "description": (
                    ...
                    "usage": "infobim 4d --container <path>",
            },
            {
                "accepts": ["--port"],
                "valued": True,
    ...
    # costs nothing and lets `infobim 4d` alone work too.
    ...
    def accepts(args: List[str]) -> bool:
        if not args or args[0] != "4d":
            return False
        return FourDTaskCommand._parse(args[1:]) is not None
    ...
    def run(self) -> CommandResponse:
        ...
        if options is None:
            raise ValueError(
                "Invalid arguments for `infobim 4d`. "
                "See `infobim 4d --help`."
            )
